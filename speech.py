...
sample_ds = preprocess_dataset([str(audioTest)])
nameModel = os.path.dirname(os.path.realpath(__file__))+'/model/model_speech.h5'
def getModel():
    model = None
...
for spectrogram, label in sample_ds.batch(1):
    ...
    print()
    print('The answer is: ' + commands[np.argmax(tf.nn.softmax(prediction[0]))])
    # print(commands)
    # plt.figure(figsize=(10, 8))
